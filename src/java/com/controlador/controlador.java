                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                           // File f = new File("C:\\Users\\bryan\\OneDrive\\Escritorio\\proyecto_final1\\web\\imagenes\\productos\\" + fileItem.getName());
                           File f = new File("C:\\Users\\NICOL\\Documents\\NetBeansProjects\\proyecto_final1\\web\\imagenes\\productos\\" + fileItem.getName()); 
                           fileItem.write(f);
