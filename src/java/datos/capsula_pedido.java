...
public class capsula_pedido {
    ...
    private pedido FK_capsula_pedido_pedido;
    ...
    public capsula_pedido(int capsula_pedido_id, int capsula_pedido_pedido,int pedido_id, int pedido__cliente, String cliente_nombre, String cliente_apellido, int pedido_telefono, int id_distrito, String desdist, int provincia_id, String despro, int departamento_id, String desdep, String pedido_fecha, int pedido_estado, int capsula_pedido_trabajador) {
        this.capsula_pedido_id = capsula_pedido_id;
        this.capsula_pedido_pedido = capsula_pedido_pedido;
    ...
    public capsula_pedido(int pedido_id) {
        this.pedido_id = pedido_id;
    }
    ...
    public pedido getFK_capsula_pedido_pedido() {
        return FK_capsula_pedido_pedido;
    }

    public void setFK_capsula_pedido_pedido(pedido FK_capsula_pedido_pedido) {
        this.FK_capsula_pedido_pedido = FK_capsula_pedido_pedido;
    }
