...
stock_producto	int	Unchecked
stock_cantidad	int	Unchecked
		Unchecked*/
    
    private int stock_id,stock_cantidad,stock_producto;
    ...
    public stock(int stock_id, int stock_cantidad) {
        this.stock_id = stock_id;
        this.stock_cantidad = stock_cantidad;
    }

    public stock(int stock_id, int stock_cantidad, int producto_id, String producto_nombre, float producto_precio, String categoria_nombre, String producto_peso, String producto_tipo_peso) {
        this.stock_id = stock_id;
        this.stock_cantidad = stock_cantidad;
        this.producto_id = producto_id;
        this.producto_nombre = producto_nombre;
