...
public class capsula_trabajador {
    ...
    private capsula_trabajador FK_capsula_trabajador_repartidor;
    ...
    public capsula_trabajador(int capsula_trabajador_id, int capsula_trabajador_trabajador, int capsula_trabajador_repartidor, String trabajador_nombre, String trabajor_apellido, String trabajador_telefono) {
        this.capsula_trabajador_id = capsula_trabajador_id;
        this.capsula_trabajador_trabajador = capsula_trabajador_trabajador;
        this.capsula_trabajador_repartidor = capsula_trabajador_repartidor;
    ...
    public capsula_trabajador getFK_capsula_trabajador_repartidor() {
        return FK_capsula_trabajador_repartidor;
    }

    public void setFK_capsula_trabajador_repartidor(capsula_trabajador FK_capsula_trabajador_repartidor) {
        this.FK_capsula_trabajador_repartidor = FK_capsula_trabajador_repartidor;
    }
