                    ...
                    <div id="contenedor2">
                        ...
                        <div id="listaDeseo" >
                            <form action="controlador_producto.jsp">
                                ...
                                <input type="submit" name="lista_deseos" value="ingresar"  class="btn" style="background: #CE6100; color: #ffffff" />
                        ...
                        <form action="controlador_producto.jsp">
                            ...
                            <input type="submit" name="lista_deseos" value="quitar" class="btn" style="background: #DD4A68; color: #ffffff" />
