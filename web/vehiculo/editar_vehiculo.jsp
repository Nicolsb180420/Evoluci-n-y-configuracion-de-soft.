    ...
    <body>
        ...
        <div class="container" style="min-height: 40vh; width: auto">
            <div class="row">
                <div class="col-12">
                    <center>
                        <p class="h3" style="color: #CE6100"> <strong>Actualizar vehiculo</strong></p> <br>
                    </center>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Codigo" name="txtid" value="<%out.print(id_temp); %>" required="">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Placa</span>
                            </div>
                            <input type="text" class="form-control" placeholder="Placa" name="txtplaca" value="<%out.print(placa); %>" required="">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Marca</span>
                            </div>
                            <input type="text" class="form-control" placeholder="Marca" name="txtmarca" value="<%out.print(marca); %>" required="">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Modelo</span>
                            </div>
                            <input type="text" class="form-control" placeholder="Modelo" name="txtmodelo" value="<%out.print(modelo); %>" required="">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Capacidad de carga</span>
                            </div>
                            <input type="text" class="form-control" placeholder="CapCarga"   name="txtcarga" value="<%out.print(carga); %>" required="">
                        </div>
