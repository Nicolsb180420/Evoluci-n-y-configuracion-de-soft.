    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <center>
                        <p class="h3" style="color: #CE6100"> <strong>Datos del vehiculo</strong></p> <br>
                    </center>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Codigo" value="<%out.print(id_temp); %>" disabled="">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Placa</span>
                            </div>
                            <input type="text" class="form-control" placeholder="Placa" value="<%out.print(placa); %>" disabled="">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Marca</span>
                            </div>
                            <input type="text" class="form-control" placeholder="Marca" value="<%out.print(marca); %>" disabled="">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Modelo</span>
                            </div>
                            <input type="text" class="form-control" placeholder="Modelo" value="<%out.print(modelo); %>" disabled="">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Capacidad de carga</span>
                            </div>
                            <input type="text" class="form-control" placeholder="CapCarga" value="<%out.print(carga); %>" disabled="">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Fecha Registro</span>
                            </div>
                            <input type="date" class="form-control" placeholder="Registro" value="<%out.print(fecha); %>" disabled="">
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="row">
                            <center>
                               <input type="submit" name="btnAceptar" value="Aceptar" class="btn btn-danger" />
                            </center>
                        </div>
