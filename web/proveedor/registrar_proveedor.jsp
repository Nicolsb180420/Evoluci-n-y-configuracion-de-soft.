                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Ruc" name="txtruc" maxlength="11">
                        </div>
                    ...
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Telefono" name="txttelefono" maxlength="9">
                            </div>
                        </div>
