    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <center>
                        <p class="h3" style="color: #CE6100"> <strong>Mantener proveedor</strong></p> <br>
                    </center>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <%
                                    proveedor temp2 = new proveedor();
                                    logica_proveedor con2 = new logica_proveedor();

                                    con2.consultar();

                                    for (int i = 0; i < logica_proveedor.Lproveedores.size(); i++) {
                                        temp2 = (proveedor) logica_proveedor.Lproveedores.get(i);

                                %>

                                <tr>
                                    <td><%=temp2.getProveedor_id()%></td>
                                    <td><%=temp2.getProveedor_razon_social()%></td>
                                    <td><%=temp2.getProveedor_ruc()%></td>
                                    <td><%=temp2.getDesdist()%></td>
                                    <td><%=temp2.getProveedor_direccion()%></td>
                                    <td><%=temp2.getProveedor_email()%></td>
                                    <td><%=temp2.getProveedor_telefono()%></td>
                                    <td><%=temp2.getProveedor_fecha_registro()%></td>
                                    <td><a href="ver_proveedor.jsp?id=<%=temp2.getProveedor_id()%>" class="btn">
                                            <img src="../imagenes/ver_producto.png" width="30" height="30" alt="ver_producto"/>

                                        </a> </td>
                                    <td><a href="editar_proveedor.jsp?id=<%=temp2.getProveedor_id()%>" class="btn">
                                            <img src="../imagenes/editar_producto.png" width="30" height="30" alt="editar_producto"/>

                                        </a> </td>
                                    <td><a href="eliminar_proveedor.jsp?id=<%=temp2.getProveedor_id()%>" class="btn">
                        ...
                        <a href="registrar_proveedor.jsp"><button type="button" class="btn btn-danger"style=" background: #CE6100 ">NUEVA</button></a> 
                    </div>
                </div>
            </div>
        </div>
