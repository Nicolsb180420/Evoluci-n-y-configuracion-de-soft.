                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="ver_proveedor.jsp?id=<%=temp2.getProveedor_id() %>" class="btn btn-danger">VER</a> </td>
                                    <td><a href="editar_proveedor.jsp?id=<%=temp2.getProveedor_id() %>" class="btn btn-danger">EDITAR</a> </td>
                                    <td><a href="eliminar_proveedor.jsp?id=<%=temp2.getProveedor_id() %>" class="btn btn-danger">ELIMINAR</a> </td>
                                </tr>
                                <%}%>
                            </tbody>
                        </table>   

                            <a href="registrar_proveedor.jsp"><button type="button" class="btn btn-danger">NUEVA</button></a> 
                    </div>
                </div>
            </div>
        </div>      
